function [ mat_subsets_numerical, mat_subsets_boolean ] = fnSubsetIndices( v_set, i_size )
%fnSubsetsIndices Summary of this function goes here
%   Detailed explanation goes here

    mat_subsets = fnSubset(v_set, i_size);
    
    mat_subsets_numerical = uint8(mat_subsets);
