...
[mat_confusion_faces, mat_correct_faces, i_correct_faces, f_correct_faces] = fnConfusion(mat_train, v_class, i_count_classes);
mat_confusion_faces_grayscale = fnSaveMatrixImage(mat_confusion_faces,'confusion_faces.png','png');
mat_correct_faces_grayscale = fnSaveMatrixImage(mat_correct_faces,'correct_faces.png','png');

obj_faces.mat_confusion = mat_confusion_faces;
obj_faces.mat_correct = mat_correct_faces;
obj_faces.i_correct = i_correct_faces;
...
obj_faces.mat_confusion_grayscale = mat_confusion_faces_grayscale;
obj_faces.mat_correct_grayscale = mat_correct_faces_grayscale;
...
[mat_confusion_letters, mat_correct_letters, i_correct_letters, f_correct_letters] = fnConfusion(mat_train, v_class, i_count_classes);
mat_confusion_letters_grayscale = fnSaveMatrixImage(mat_confusion_letters,'confusion_letters.png','png');
mat_correct_letters_grayscale = fnSaveMatrixImage(mat_correct_letters,'correct_letters.png','png');


obj_letters.mat_confusion = mat_confusion_letters;
obj_letters.mat_correct = mat_correct_letters;
obj_letters.i_correct = i_correct_letters;
...
obj_letters.mat_confusion_grayscale = mat_confusion_letters_grayscale;
obj_letters.mat_correct_grayscale = mat_correct_letters_grayscale;
